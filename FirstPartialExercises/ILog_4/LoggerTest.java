package Napredno_Programiranje.FirstPartialExercises.ILog_4;
...
class LogSystem <T extends ILog> {
    ...
    void printResults() {
        ...
        LogProcessor<T> firstLogProcessor = (logsList)->logsList.stream().filter(log->log.getType().equals("INFO")).collect(Collectors.toCollection(()->new ArrayList<>()));
