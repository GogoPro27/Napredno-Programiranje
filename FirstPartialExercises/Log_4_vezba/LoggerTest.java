package Napredno_Programiranje.FirstPartialExercises.Log_4_vezba;
...
class LogSystem <T extends ILog>{
        ...
        //TODO constructor
        public LogSystem(ArrayList<T> logovi) {
    ...
    void printResults() {
        ...
        LogProcessor<T> secondLogProcessor = loglist -> loglist.stream().filter(log->log.getMessage().length()<100).collect(Collectors.toCollection(()->new ArrayList<>()));
